      ...
      <div className="max-w-7xl mx-auto py-10 px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-col space-y-2 text-sm">
              <Link href="/creator" className="text-muted-foreground hover:text-foreground">Creator studio</Link>
              ...
              <Link href="/support" className="text-muted-foreground hover:text-foreground">Artist support</Link>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-col space-y-2 text-sm">
              <Link href="https://twitter.com" target="_blank" className="text-muted-foreground hover:text-foreground">Twitter</Link>
              <Link href="https://instagram.com" target="_blank" className="text-muted-foreground hover:text-foreground">Instagram</Link>
              <Link href="https://discord.com" target="_blank" className="text-muted-foreground hover:text-foreground">Discord</Link>
              <Link href="https://github.com" target="_blank" className="text-muted-foreground hover:text-foreground">GitHub</Link>
            </div>
          </div>
        </div>
