...
export default function ContentStudioPage() {
  ...
  // Fetch drafts
  const draftSongs = useQuery(api.music.getDraftSongsByArtist, { artistId: userId }) ?? [];
  const allAlbums = useQuery(api.music.getAlbumsByArtist, { artistId: userId }) ?? [];
  ...
  const publishedSongs = useQuery(api.music.getSongsByArtist, { artistId: userId }) ?? [];
  const publishedSongsCount = publishedSongs.filter(song => song.isPublic).length;
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-xs text-muted-foreground mt-1">
                {publishedSongsCount} songs, {allAlbums.filter(a => a.isPublic).length} albums
              </p>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-end justify-between">
                <h3 className="text-2xl font-bold">
                  {publishedSongs.reduce((sum, song) => sum + (song.plays || 0), 0)}
                </h3>
            ...
            <CardContent className="p-0">
              <Tabs value={activeTab} onValueChange={setActiveTab}>
                    ...
                    <ScrollArea className="h-[400px] px-6">
                      <div className="space-y-4 pt-1 pb-6">
                        {draftSongs.slice(0, 5).map((song) => (
                          <div key={song._id} className="flex items-center justify-between py-2 border-b">
                        ...
                        {draftAlbums.slice(0, 5).map((album) => (
                          <div key={album._id} className="flex items-center justify-between py-2 border-b">
                            <div className="flex items-center gap-3">
                              <div className="h-10 w-10 rounded bg-secondary overflow-hidden flex-shrink-0">
                                {album.coverArt ? (
                                  <Image 
                              ...
                              <div>
                                ...
                                <div className="flex items-center gap-2">
                                  <Badge variant="secondary" className="text-xs">Album</Badge>
                                  <span className="text-xs text-muted-foreground">
                ...
                <TabsContent value="published" className="mt-6">
                  <ScrollArea className="h-[400px] px-6">
                    <div className="space-y-4 pt-1 pb-6">
                      {publishedSongs.filter(song => song.isPublic).slice(0, 10).map((song) => (
                        <div key={song._id} className="flex items-center justify-between py-2 border-b">
                          <div className="flex items-center gap-3">
                            <div className="h-10 w-10 rounded bg-secondary overflow-hidden flex-shrink-0">
                              {song.coverArt ? (
                ...
                <TabsContent value="all" className="mt-6">
                  <div className="px-6 pb-6">
                    <div className="rounded-lg border p-6 text-center">
                      ...
                      <p className="mt-2 text-sm text-muted-foreground">
                        View comprehensive lists of all your content in the dedicated sections.
                      </p>
          ...
          <div className="grid gap-4 py-4">
            ...
            >
              <div className="flex items-center space-x-2 pb-2 border-b">
                ...
                <Label htmlFor="song" className="flex items-center cursor-pointer">
                  <Music className="mr-2 h-4 w-4" />
                  Song
                </Label>
              </div>
              <div className="flex items-center space-x-2 pb-2 border-b">
                ...
                <Label htmlFor="album" className="flex items-center cursor-pointer">
                  <Disc className="mr-2 h-4 w-4" />
                  Album
                </Label>
              </div>
              <div className="flex items-center space-x-2 pb-2 border-b opacity-60">
                ...
                <Label htmlFor="playlist" className="flex items-center cursor-not-allowed">
              ...
              <div className="flex items-center space-x-2 pb-2 border-b opacity-60">
                ...
                <Label htmlFor="blog" className="flex items-center cursor-not-allowed">
                  <FileText className="mr-2 h-4 w-4" />
