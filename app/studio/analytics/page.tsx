...
export default function AnalyticsPage() {
  ...
  const popularSongs = [...allSongs].sort(
  ...
  const engagementRate =
    totalPlays > 0 ? Math.round((totalLikes / totalPlays) * 100) : 0;
  ...
  const generateSampleData = (
    max: number,
    trend: "up" | "down" | "fluctuate" | "stable" = "up"
  ) => {
    const length =
      timeFrame === "7days"
        ? 7
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Track your music&apos;s performance and audience
          </p>
        </div>
        <Select
          value={timeFrame}
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center">
                <div className="text-2xl font-bold mr-2">
                  {avgPlaysPerSong.toLocaleString()}
                </div>
                <Badge variant="outline" className="text-green-500">
                  <TrendingUp className="h-3 w-3 mr-1" />
                  +3%
        ...
        <TabsContent value="engagement" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Track your song&apos;s listens over{" "}
                  {timeFrame === "year"
                    ? "the last year"
                    : `the last ${timeFrame}`}
                </CardDescription>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Track how many people liked your songs
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-[300px]">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                The percentage of plays that resulted in likes
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-[300px]">
        ...
        <TabsContent value="songs" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Your most played songs in this period
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
