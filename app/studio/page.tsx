...
export default function StudioPage() {
  ...
  const popularSongs = [...(userSongs || [])].sort((a, b) => (b.plays || 0) - (a.plays || 0)).slice(0, 5);
  ...
  const totalPlays = allSongs?.reduce((sum, song) => sum + (song.plays || 0), 0) || 0;
  const totalLikes = allSongs?.reduce((sum, song) => sum + (song.likes || 0), 0) || 0;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Track your song&apos;s listening trends</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Monthly likes received on your songs</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-[300px]">
                  <Bar 
                ...
                {popularSongs?.length > 0 ? (
                  <ul className="space-y-4">
                    {popularSongs.map((song, index) => (
                      <li key={song._id} className="flex items-center justify-between border-b pb-2">
                        <div className="flex items-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>Latest interactions with your music</CardDescription>
          </CardHeader>
            ...
            <div className="space-y-4">
              <div className="flex items-start border-b pb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Someone played &quot;Summer Vibes&quot;</p>
              ...
              <div className="flex items-start border-b pb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Someone liked &quot;Night Drive&quot;</p>
              ...
              <div className="flex items-start border-b pb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Someone discovered your music for the first time</p>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Someone listened to &quot;Ocean Waves&quot; in full</p>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <Button className="w-full justify-start" variant="outline" onClick={() => router.push('/studio/upload')}>
              <Upload className="mr-2 h-4 w-4" />
              Upload New Song
            </Button>
            
            <Button className="w-full justify-start" variant="outline" onClick={() => router.push('/studio/drafts')}>
              <Edit className="mr-2 h-4 w-4" />
              Manage Drafts ({draftSongs})
            </Button>
            
            <Button className="w-full justify-start" variant="outline" onClick={() => router.push('/studio/analytics')}>
              <BarChart2 className="mr-2 h-4 w-4" />
              View Detailed Analytics
            </Button>
            
            <Button className="w-full justify-start" variant="outline" onClick={() => router.push('/studio/songs')}>
